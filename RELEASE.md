...
Это чеклист **первого** деплоя. Сайт уже живой: https://vera-automation.online. Не проходи шаги заново. Не создавай GitHub-токен — `gh` уже залогинен.

Текущая работа и следующие тикеты: `HANDOFF.md` и Linear-проект [See how people use it](https://linear.app/subscription-track/project/see-how-people-use-it-224181d159f1) (PostHog, старт с SUB-29).

---

Делай строго сверху вниз **только если поднимаешь инстанс с нуля**. После каждого **СТОП** пиши мне в чат, что получилось. Не перескакивай.
